...
Oh my… here's this question that's always like "I'd have a lot of stuff to say but not off the top of my head." [Numbers Story](https://numbersstory.com) definitely is among the top. And [BNT's site](https://bntarwarn.com). There are many more sites that I love but I discovered them a lot later so they don't really count as inspiration.
...
Refer to [this post](/posts/2025-10-26) — I don't know what my real self looks like. But I don't try to construct a persona, so I suppose this is my real self.
...
[Fluid typography](/posts/2025-10-07#responsiveness).
...
I like them! Though I think I'm now in enough of them that I don't actively join more. I also have [one](https://oc-webring.neocities.org) myself!
...
[Lexend](https://www.lexend.com/) [Lexend](https://www.lexend.com/) [Lexend](https://www.lexend.com/) [Lexend](https://www.lexend.com/) [Lexend](https://www.lexend.com/) [Lexend](https://www.lexend.com/) —
...
It's HTML's [half-sister](https://tofutush.neocities.org/characters/willow/) born with a [stepfather](https://tofutush.neocities.org/characters/peacock/) (XML) that [HTML](https://tofutush.neocities.org/characters/sparky/) hates, and said half-sister manages to throw more tantrums than HTML ever could in her life and she's an annoying, spoiled wreck.
...
[Eleventy](https://11ty.dev) [Eleventy](https://11ty.dev) [Eleventy](https://11ty.dev) [Eleventy](https://11ty.dev) [Eleventy](https://11ty.dev) [Eleventy](https://11ty.dev) —
...
Yeah, the [Hillslope comics](/posts/2025-11-17).
...
Yes, I turn most of them into `.webp`s to torture y'all. The refsheets are available in `.png` though. And you can easily find all `.png`s on the Github repo.
