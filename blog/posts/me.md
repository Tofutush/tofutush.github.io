...
This post took a long span of time to write, with me adding stuff on days I thought of stuff to add, so it may be quite disorganized.

Something I noticed about me is that, I don't like describing myself as "I am something," and I prefer "I like doing something" instead. I am not an artist, but I like drawing. I am not a programmer, but I like coding. Maybe I just hate labeling myself. I am Tofu and I am nothing else. And Tofu likes doing things sometimes. I mean, doesn't this make sense? I draw sometimes, and sometimes I don't draw. What did you expect, to draw 24/7? I'm hesitant to label myself an artist because it makes me feel like I have to draw 24/7 or something.

The only thing I'd label myself as is "paracosmist." I'm a paracosmist and I couldn't imagine not being one. I draw and write because I want my little head creatures to come to life. I code because I want to make a website to document the entire thing.

Another thing is, I feel like I treat myself like a program, and when something is wrong, I look for what exactly caused the problem as if I can just fix a line of bug and get myself running normally again. Sometimes it works out, like that time I had bad sleep for 4 days in a row and literally felt like my surroundings weren't real. I fixed that by, y'know, sleeping. And one time I felt like my chest was always under pressure and I had trouble breathing. Turned out I put my bra on the wrong way. But sometimes I can't find a fix, or it can only be fixed through time or effort, like anxieties about class assignments and registration. And I have this delusion that whenever I'm feeling down, I just need sugar; so I drink a bunch of cola and eat a bunch of chocolate. I know people are like, complicated creatures that aren't just "plug stuff in and get results," but it's still hard to accept that.

I feel like I know the reason why I like coding and paracosming so much, aside from both being relatively solitary activities. I mean, why I like paracosming is obvious. I'm granting these little critters life. I'm literally playing god. Drawing and writing derives from trying to put these little stories and people out on the paper and in the world.

But coding? I think it's the feeling that everything is certain. You run the same code and it always produces the same results. If not, then something's wrong; but it's always fixable. Every problem has a solution, and I can always reach my goal as long as I'm doing the right thing. Sure, things can be frustrating a lot of the time, but it's always fixable.
